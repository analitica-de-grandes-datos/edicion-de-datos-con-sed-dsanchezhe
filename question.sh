...
# sed 's/,/./g' data.csv |sed 's/;/,/g'|sed -E 's,([0-9]{2})/([0-9]{ 2})/([0-9]{2}),20\3-\2-\1,g'|sed -E's,([0-9]{1})/([0-9 ]{1})/([0-9]{4}),\3-0\2-0\1,g'
# sed 's/,/./g' data.csv |sed 's/;/,/g'|sed -E 's,([0-9]{2})/([0-9]{ 2})/([0-9]{2}),20\3-\2-\1,g'|sed -E's,([0-9]{1})/([0-9 ]{1})/([0-9]{4}),\3-0\2-0\1,g'|sed 's/,,/\, /g'|sed 's/[az ]/\U&/g'|sed 's/\N/\\N/g'
# sed 's/,/./g' data.csv |sed 's/;/,/g'|sed -E 's,([0-9]{2})/([0-9]{ 2})/([0-9]{2}),20\3-\2-\1,g'|sed -E's,([0-9]{1})/([0-9 ]{1})/([0-9]{4}),\3-0\2-0\1,g'|sed 's/,,/\, /g'|sed 's/[az ]/\U&/g'|sed's/\ N/\\N/g'|sed's/,N/,\\N/g'|sed's/,\\N,\\n/ &\N/g'
sed ' s/,/./g ' datos.csv \
        | sed ' s/;/,/g ' \
